...
function link_hover_trackers() {
    $('.logo-link-holder').on('mouseenter', function() {
        ...
        $(this).find('.logo-link-holder__a-mail').css("filter", "brightness(0) saturate(100%) invert(100%) sepia(0%) saturate(7498%) hue-rotate(38deg) brightness(93%) contrast(110%)");
    });
    $('.logo-link-holder').on('mouseleave', function() {
        ...
        $(this).find('.logo-link-holder__a-mail').css("filter", "brightness(0) saturate(100%) invert(64%) sepia(7%) saturate(16%) hue-rotate(317deg) brightness(86%) contrast(86%)");
    })
}
